...
export default function Signup() {
    ...
    return (
        <>
            <main className="max-w-full relative max-xs:px-0 max-sm:py-20 min-h-screen flex">
                <BgImg className="z-0 inset-0" url={"./img/login.jpg"} />
                <section className="z-10 w-[min(100%,1291px)] px-0 xs:px-4  mx-auto flex-grow flex flex-col lg:flex-row flex-wrap justify-between max-lg:justify-center items-center">
